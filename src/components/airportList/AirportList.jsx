      ...
      renderCell: (params) => {
        return (
          <>
            ...
            <MdOutlineDelete
              className="AirportListDelete"
              onClick={() => onDeleteAirport(params.row)}
            />
          </>
        );
      },
    ...
    <>
      ...
      {showModal ? (
        <Modal
          ...
          actions={actions}
          header="Warning"
          content={`Do you want to delete ${selectedAirport.name} ?`}
        />
      ) : null}
...
export default connect(mapStateToProps, { fetchAirports, deleteAirport })(
  AirportList
);
