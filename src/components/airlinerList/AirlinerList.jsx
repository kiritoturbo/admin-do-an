...
function AirlinerList(props) {
  ...
  const columns = [
    ...
    { field: "manufacturer", headerName: "Manufacturer", width: 150 },
    {
      ...
      headerName: "Date of Commissioning",
      width: 200,
    },
    {
  ...
  if (!props.airliners) return <div>Loading...</div>;
  return (
    <>
      ...
      {showModal ? (
        <Modal
          ...
          content={`Do you want to delete ${
            selectedAirliner.manufacturer + " " + selectedAirliner.model
          } ?`}
        />
      ) : null}
...
export default connect(mapStateToProps, { fetchAirliners, deleteAirliner })(
  AirlinerList
);
